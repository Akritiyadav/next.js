...
export default function Home() {
  return (
    <>
      <Head>
        ...
        <link rel="icon" href="/codeswear.png" />
      </Head>
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Wear the codes with codeswear.com</h1>
      <p class="lg:w-1/2 w-full leading-relaxed text-gray-500">Wear whatever you wqant ? Everything is available here and that is ver good and interesting So hurry up.</p>
    </div>
